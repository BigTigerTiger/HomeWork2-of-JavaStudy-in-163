 ...
 *  4、Game：主程序。建立了内部类Handler，通过switch-case方式，表示各个命令对应的执行程序；按每行的方式将欢迎语句封开，放入ArrayList，并在构造的时候初始化欢迎语句；
 *  这样的设计方式的好处：
...
public class Game {
    ...
    private ArrayList<String> lines= new ArrayList<String>();	//欢迎语句 
    //创建命令的内部类
    private class Handler {   
    	...
    	public void docmd(String[] cmd) {
    		...
    		case "go":
    			...
    			break;
    		default :
    			System.out.println("您输入的命令错误！你可以做的命令有：go bye help");
    		}
    	}
    ...
    private void printWelcome() {
        for(String k: lines) System.out.println(k);
    ...
    public void goRoom(String direction) 
    {
        ...
        if (nextRoom == null) {
            System.out.println("那里没有门！请输入正确的方向！");
        }
        else {
